...
export class WorkoutsController {
  ...
  create(@Request() req: any, @Body() dto: CreateWorkoutPlanDto) {
    ...
    return this.workoutsService.create(dto, req.user.gymId, req.user.userId, branchId);
  }
  ...
  assignWorkout(@Request() req: any, @Body() dto: AssignWorkoutDto) {
    const branchId = req.user.branchId ?? null;
    return this.workoutsService.assignWorkout(dto, req.user.gymId, req.user.userId, branchId);
  }
